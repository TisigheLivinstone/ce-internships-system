            ...
            <div class="row">
                <div class="col-sm-6 col-xl-3 align-self-center">
                    <div class="single_feature_text ">
                        <h2>About Us</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo tenetur!</p>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <h4>Vision</h4>
                            <p>Excellence in producing highly skilled, well qualified and globally competitive Information Technology duation</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <h4>Mission</h4>
                            <p>Committed to provide affordable and high quality education for the training and development of professionals Computer Engineers</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part single_feature_part_2">
                            ...
                            <h4>Objectives</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo tenetur aut aliquid iste similique, amet quisquam corrupti voluptas.</p>
                ...
                <div class="col-md-5 col-lg-5">
                    <div class="learning_member_text">
                        ...
                        <h2>Learning with Love
                            and Laughter</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit, quo ex odio nesciunt eaque, mollitia reprehenderit itaque minus accusamus officia quas! Dolores rerum facere, eligendi impedit consequatur commodi quasi aliquam!Dolore modi ratione, unde provident deleniti commodi dignissimos error. Impedit nulla suscipit commodi delectus odit. Illo officia molestias tenetur amet sit suscipit libero ducimus deleniti, error excepturi molestiae laboriosam impedit.</p>
                        <ul>
