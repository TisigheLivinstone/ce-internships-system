...
<html lang = "eng">
	<head>
		<title>Computer Engineerng Internships</title>
		<meta charset = "UTF-8" />
...
<!-------------------SIDEBAR------------------>
		...
		<div id = "sidecontent" class = "well pull-right">
			...
			<button type = "button" id = "add_activity" class = "btn btn-success"><span class = "glyphicon glyphicon-plus"></span> Add New job</button>
