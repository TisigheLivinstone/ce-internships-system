                ...
                <div class="col-lg-6 col-xl-6">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            <h5>Every Student yearns to learn</h5>
                            <h1>Making our Students
                                World Better</h1>
                                <p>
                                    Produce students with technical skills
                                    ...
                                    Provide continues specialized faculty training and professional development,
                                    Acquire implement and utilize technologies to support for the instructional, administrative, research, and development and extensive needs,
